...
private:
	...
	static constexpr double m_dAlpha_foot = 0.1;
	static constexpr double m_dAlpha_torsoH = 1.0;
	static constexpr double m_dAlpha_torsoV = 0.1;

	static constexpr double m_dTargetVel_mps = 1.0;

	static constexpr double m_dCostCoeff_u = 1e-4;

	static const int m_nLeftFootBodyID = 3;
	static const int m_nRightFootBodyID = 5;
